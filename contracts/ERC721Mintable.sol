...
contract ERC721 is Pausable, ERC165 {
    ...
    function transferFrom(
        ...
        require(_isApprovedOrOwner(msg.sender, tokenId),"msg.sender is not owner of this token ID or is not approved");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURItoSpecifiedTokenId(uint256 tokenId) internal {
        ...
        string memory _tokenURI = strConcat(_baseTokenURI, tokenIdtoString);
